...
| `auto_discover_peers` | `False` | `False`, `True` | browse local network for other ariaflow instances and auto-download their torrents |
...
- **Decision ID:** `ariaflow-scheduler-001`
